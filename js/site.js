...
(function () {
  ...
  if (window.gsap && window.ScrollTrigger) {
    ...
    mm.add({ motion: '(prefers-reduced-motion: no-preference)', wide: '(min-width: 900px)' }, function (ctx) {
      ...
      // Темп: панели листали на тачпаде в 3–4 движения и прокрутка казалась отстающей. Пауза между панелями — 120–180 px вместо 40svh (меньше нельзя, sticky-cover.js),
      // сглаживание 0,2 с вместо 0,4: движение по-прежнему плавное, но идёт за пальцем.
      ...
      dests.forEach(function (d, i) {
        ...
        var tl = gsap.timeline({
          ...
          scrollTrigger: {
            trigger: destsBox, scrub: 0.2, invalidateOnRefresh: true,
